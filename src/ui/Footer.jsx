          ...
          <Row>
              ...
              <Row>
                <Col md={10} className="footer-top">
                  ...
                  <div className="footer-social">
                    <ul>
                      <li>
                        <a href="https://www.linkedin.com/company/the-mindarrow-media/?viewAsMember=true" target="_blank" rel="noreferrer">
                          <FaLinkedinIn />
                        </a>
                      </li>
                      <li>
            ...
            <Col lg={4} md={6}>
              <div className="footer-info mt-30">
                ...
                <ul>
                  <li>
                    <FaRegAddressCard /> 445 Main Street, New York CA-12325, USA{' '}
                  </li>
                  <li>
                    <FaPhoneAlt />{' '}
                    <a href="tel:+00 125 456 888" className="text-white">
                      +00 125 456 888
                    </a>{' '}
                  </li>
                  <li>
                    <IoMailOutline />{' '}
                    <a href="mailto:contact@gmail.com" className="text-white">
                      contact@gmail.com
                    </a>{' '}
                  </li>
                </ul>
