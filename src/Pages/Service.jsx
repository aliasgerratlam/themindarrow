            ...
            <section className="service-area service-page-area pb-100">
                <Container>
                    <div className="heading-1 text-center">
                        <h1 className="display-5">Mindful Services of <span>TheMindArrow</span> </h1>
                            ...
                            <ReactWOW animation='fadeInRight' delay='0.2s'>
                                <div className="service-item">
                                    ...
                                    <div className="content">
                                        ...
                                        <p>Mindarrow’s trading and investment team has the expertise to analyse and negotiate across all media touchpoints- online, offline, global or local. Such sound is their analysis that they ttime and again deliver the most effective contact point for every client to any consumer. Mindarrow also holds the edge in developing market leading tools and services including carbon calculators, designed to empower clients for making conscious decisions around media plan impact and inclusion PMPs, private market places that intentionally direct, investment to marginalized communities that adversely impacted by aggressive keyword exclusion list.
                                    </p>
                                    </div>
                                </div>
                            </ReactWOW>
                            ...
                            <Col lg={4} md={6}>
                                <ReactWOW animation='fadeInUp' delay='0.2s'>
                                    <div className="sub-2-item mt-30">
                                        ...
                                        <p>Drive targeted traffic to your website through strategic and cost-effective PPC campaigns.
                                        </p>
                                    </div>
                                </ReactWOW>
                            </Col>
                            <Col lg={4} md={6}>
                                <ReactWOW animation='fadeInUp' delay='0.2s'>
                                    <div className="sub-2-item mt-30 item-3">
                                        ...
                                        <p>Engage and enhance your brands visibility on popular social platforms with Mindarrow’s effective social media marketing strategies.
                                        </p>
                                    </div>
                                </ReactWOW>
                            </Col>
                            <Col lg={4} md={6}>
                                <ReactWOW animation='fadeInUp' delay='0.2s'>
                                    <div className="sub-2-item mt-30 item-3">
                                        ...
                                        <p>Express, Elevate and stamp your brand with Mindarrow’s compelling and relevant content that resonates with your target audience.
                                        </p>
                                    </div>
                                </ReactWOW>
                            </Col>
